    ...
    internal class RouteParserTests
    {
        ...
        public static IEnumerable<(string Route, IEnumerable<RouteSegment> Parsed, Action<Mock<RouteParser>>? Assert)> Cases
        {
            get
            {
                ...
                yield return ("/cica/{param:int}", new RouteSegment[] { new RouteSegment("cica", null, null), new RouteSegment("param", DefaultConverters.IntConverter, null) }, null);
                yield return ("/cica/{param:int}/kutya", new RouteSegment[] { new RouteSegment("cica", null, null), new RouteSegment("param", DefaultConverters.IntConverter, null), new RouteSegment("kutya", null, null) }, null);
                yield return ("/cica/{param:int:}", new RouteSegment[] { new RouteSegment("cica", null, null), new RouteSegment("param", DefaultConverters.IntConverter, null) }, null);
                yield return ("/cica/pre-{param:int}", new RouteSegment[] { new RouteSegment("cica", null, null), new RouteSegment("param", WrappedParser, null) }, mock => mock.Protected().Verify<TryConvert>("Wrap", Times.Once(), "pre-", "", (TryConvert) DefaultConverters.IntConverter));
                yield return ("/cica/{param:int}-su", new RouteSegment[] { new RouteSegment("cica", null, null), new RouteSegment("param", WrappedParser, null) }, mock => mock.Protected().Verify<TryConvert>("Wrap", Times.Once(), "", "-su", (TryConvert) DefaultConverters.IntConverter));
                yield return ("/cica/pre-{param:int}-su", new RouteSegment[] { new RouteSegment("cica", null, null), new RouteSegment("param", WrappedParser, null) }, mock => mock.Protected().Verify<TryConvert>("Wrap", Times.Once(), "pre-", "-su", (TryConvert) DefaultConverters.IntConverter));
                yield return ("/cica/pre-{param:int}-su/kutya", new RouteSegment[] { new RouteSegment("cica", null, null), new RouteSegment("param", WrappedParser, null), new RouteSegment("kutya", null, null) }, mock => mock.Protected().Verify<TryConvert>("Wrap", Times.Once(), "pre-", "-su", (TryConvert) DefaultConverters.IntConverter));
                yield return ("/cica/{param:int:x}", new RouteSegment[] { new RouteSegment("cica", null, null), new RouteSegment("param", DefaultConverters.IntConverter, "x") }, null);
                yield return ("/cica/{param:int}/mica/{param2:str}", new RouteSegment[] { new RouteSegment("cica", null, null), new RouteSegment("param", DefaultConverters.IntConverter, null), new RouteSegment("mica", null, null), new RouteSegment("param2", DefaultConverters.StrConverter, null) }, null);
                yield return ("/cica/{param:int}/{param2:str}", new RouteSegment[] { new RouteSegment("cica", null, null), new RouteSegment("param", DefaultConverters.IntConverter, null), new RouteSegment("param2", DefaultConverters.StrConverter, null) }, null);
            }
        }
        ...
        public void ParseShouldThrowOnDuplicateParameterName([Values("{param:int}/{param:int}", "{param:int}/pre-{param:int}", "{param:int}/segment/{param:int}")] string input) =>
            Assert.Throws<ArgumentException>(() => new RouteParser(new Dictionary<string, TryConvert> { { "int", new Mock<TryConvert>(MockBehavior.Strict).Object } }).Parse(input).ToList(), Resources.DUPLICATE_PARAMETER);
